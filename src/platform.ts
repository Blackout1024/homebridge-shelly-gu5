 ...
 */
export const PLUGIN_NAME = 'homebridge-shelly-gu5';
...
export class ShellyPlatform implements DynamicPlatformPlugin {
  ...
  /**
   * A reference to the node-shellies-gu5 library.
   */
  ...
  constructor(
    ...
    // setup node-shellies-gu5
    this.shellies = new Shellies({
      websocket: { ...this.options.websocket, clientId: 'homebridge-shelly-gu5-' + Math.round(Math.random() * 1000000) },
      autoLoadStatus: true,
      autoLoadConfig: true,
  ...
  /**
   * Handles 'add' events from the node-shellies-gu5 library.
   */
  ...
  /**
   * Handles 'remove' events from the node-shellies-gu5 library.
   */
  ...
  /**
   * Handles 'exclude' events from the node-shellies-gu5 library.
   */
  ...
  /**
   * Handles 'unknown' events from the node-shellies-gu5 library.
   */
  ...
  /**
   * Handles 'error' events from the node-shellies-gu5 library.
   */
